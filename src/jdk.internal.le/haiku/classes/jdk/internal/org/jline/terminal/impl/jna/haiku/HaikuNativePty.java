 ...
 */
package jdk.internal.org.jline.terminal.impl.jna.haiku;
...
import static jdk.internal.org.jline.terminal.impl.jna.haiku.CLibrary.TCSANOW;
import static jdk.internal.org.jline.terminal.impl.jna.haiku.CLibrary.TIOCGWINSZ;
import static jdk.internal.org.jline.terminal.impl.jna.haiku.CLibrary.TIOCSWINSZ;
import static jdk.internal.org.jline.terminal.impl.jna.haiku.CLibrary.termios;
import static jdk.internal.org.jline.terminal.impl.jna.haiku.CLibrary.winsize;

public class HaikuNativePty extends JnaNativePty {
...
//    private static final CLibrary C_LIBRARY = Native.load(Platform.C_LIBRARY_NAME, CLibrary.class);
    ...
    public static HaikuNativePty current(TerminalProvider provider, SystemStream systemStream) throws IOException {
        switch (systemStream) {
            case Output:
                return new HaikuNativePty(
    ...
    public static HaikuNativePty open(TerminalProvider provider, Attributes attr, Size size) throws IOException {
