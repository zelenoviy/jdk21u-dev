...
#include "jni_util.h"
#include "jvm.h"
#include "jdk_internal_org_jline_terminal_impl_jna_haiku_CLibraryImpl.h"
...
JNIEXPORT void JNICALL Java_jdk_internal_org_jline_terminal_impl_jna_haiku_CLibraryImpl_initIDs
  (JNIEnv *env, jclass) {
    jclass cls;
    ...
    cls = env->FindClass("jdk/internal/org/jline/terminal/impl/jna/haiku/CLibrary$termios");
    CHECK_NULL(cls);
    termios_j = (jclass) env->NewGlobalRef(cls);
    CHECK_NULL(termios_j);
    c_iflag = env->GetFieldID(termios_j, "c_iflag", "Ljdk/internal/org/jline/terminal/impl/jna/haiku/NativeLong;");
    CHECK_NULL(c_iflag);
    c_oflag = env->GetFieldID(termios_j, "c_oflag", "Ljdk/internal/org/jline/terminal/impl/jna/haiku/NativeLong;");
    CHECK_NULL(c_oflag);
    c_cflag = env->GetFieldID(termios_j, "c_cflag", "Ljdk/internal/org/jline/terminal/impl/jna/haiku/NativeLong;");
    CHECK_NULL(c_cflag);
    c_lflag = env->GetFieldID(termios_j, "c_lflag", "Ljdk/internal/org/jline/terminal/impl/jna/haiku/NativeLong;");
    CHECK_NULL(c_lflag);
    c_cc = env->GetFieldID(termios_j, "c_cc", "[B");
    CHECK_NULL(c_cc);
    c_ispeed = env->GetFieldID(termios_j, "c_ispeed", "Ljdk/internal/org/jline/terminal/impl/jna/haiku/NativeLong;");
    CHECK_NULL(c_ispeed);
    c_ospeed = env->GetFieldID(termios_j, "c_ospeed", "Ljdk/internal/org/jline/terminal/impl/jna/haiku/NativeLong;");
    CHECK_NULL(c_ospeed);

    cls = env->FindClass("jdk/internal/org/jline/terminal/impl/jna/haiku/CLibrary$winsize");
    CHECK_NULL(cls);
    ...
    nativelong_j = env->FindClass("jdk/internal/org/jline/terminal/impl/jna/haiku/NativeLong");
    CHECK_NULL(nativelong_j);
    nativelong_value = env->GetFieldID(nativelong_j, "value", "J");
    CHECK_NULL(nativelong_value);
}

JNIEXPORT void JNICALL Java_jdk_internal_org_jline_terminal_impl_jna_haiku_CLibraryImpl_tcgetattr
...
/*
 * Class:     jdk_internal_org_jline_terminal_impl_jna_haiku_CLibraryImpl
 * Method:    tcsetattr
 * Signature: (IILjdk/internal/org/jline/terminal/impl/jna/haiku/CLibrary/termios;)V
 */
JNIEXPORT void JNICALL Java_jdk_internal_org_jline_terminal_impl_jna_haiku_CLibraryImpl_tcsetattr
 ...
 * Class:     jdk_internal_org_jline_terminal_impl_jna_haiku_CLibraryImpl
 * Method:    ioctl0
 * Signature: (IILjdk/internal/org/jline/terminal/impl/jna/haiku/CLibrary/winsize;)V
 */
JNIEXPORT void JNICALL Java_jdk_internal_org_jline_terminal_impl_jna_haiku_CLibraryImpl_ioctl0
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_jdk_internal_org_jline_terminal_impl_jna_haiku_CLibraryImpl_isatty
 ...
 * Signature: (I[BI)V
 */
JNIEXPORT void JNICALL Java_jdk_internal_org_jline_terminal_impl_jna_haiku_CLibraryImpl_ttyname_1r
